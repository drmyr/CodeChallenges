...
class JobScheduleMinDifficultyTest {
    ...
    private final int[][]
        ...
        h = {{10,2,20,5,15,10,1}, {3}, {31}},
        i = {{10,2,20,5,15,10,1}, {5}, {43}},
        j = {{5,4,2,4,3,4,5,4}, {4}, {16}},
        k = {{22,12,1,14,17}, {2}, {39}};

    @Test
    void minDifficultyTest() {
        for(final int[][] curr : List.of(a,b,c,d,e,f,g,h,i,j,k)) {
            assertThat(curr[2][0], is(equalTo(minDifficultyDP(curr[0], curr[1][0]))));
        }
    }
}