...
public class AddTwoNumbers {
    ...
    public static ListNode addTwoNumbersLong(final ListNode l1, final ListNode l2) {
         ...
         ListNode l1ref = l1;
         while(l1ref != null) {
             sum += Math.pow(10, currentPower++) * l1ref.val;
             l1ref = l1ref.next;
         }
         ...
         ListNode l2ref = l2;
         while(l2ref != null) {
             sum += Math.pow(10, currentPower++) * l2ref.val;
             l2ref = l2ref.next;
         }
    ...
    public static ListNode addTwoNumbersBigInteger(final ListNode l1, final ListNode l2) {
        ...
        ListNode l1ref = l1;
        while(l1ref != null) {
            sum = sum.add(ten.pow(currPow++).multiply(BigInteger.valueOf(l1ref.val)));
            l1ref = l1ref.next;
        }
        ...
        ListNode l2ref = l2;
        while(l2ref != null) {
            sum = sum.add(ten.pow(currPow++).multiply(BigInteger.valueOf(l2ref.val)));
            l2ref = l2ref.next;
        }
