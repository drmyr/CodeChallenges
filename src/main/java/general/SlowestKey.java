...
public class SlowestKey {
    ...
    /**
     * https://cybergeeksquad.co/2021/06/slowest-key-solution-amazon-oa-2021.html
     *
     ...
     * The ithkeypress had a duration of releaseTimes[i] - releaseTimes[i - 1],
     ...
     * @return
     */
    public static char slowestKey(final int[] releaseTimes, final String keysPressed) {
        ...
        for(int i = 1; i < releaseTimes.length; i++) {
            ...
            if(releaseTimes[i] - releaseTimes[i - 1] == max) {
                indexOfMax = keysPressed.charAt(indexOfMax) > keysPressed.charAt(i) ? indexOfMax : i;
            }
        }
